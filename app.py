...
sum_conflicts_data["Date of Events"] = pd.to_datetime(sum_conflicts_data["Date of Events"])
...
shapefile = shapefile.Reader("https://github.com/davidadzavon/Msc_thesis_webapp/blob/main/study%20area%20maping/gadm36_BFA_shp/gadm36_BFA_shp/gadm36_BFA_1.shp")
